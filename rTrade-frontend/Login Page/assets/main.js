(function() {
	...
	// "On Visible" animations.
		onvisible.add('#image02', { style: 'tilt-left', speed: 750, intensity: 10, delay: 0, state: true, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-left', speed: 750, intensity: 3, delay: 0, state: true, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-right', speed: 750, intensity: 3, delay: 0, state: true, replay: false });
		onvisible.add('form.style1', { style: 'fade-up', speed: 750, intensity: 3, delay: 0, state: true, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 750, intensity: 3, delay: 0, stagger: 125, state: true, replay: false });
